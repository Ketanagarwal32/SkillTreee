...
export async function triggerGroqArcGeneration(
  ...
  const prompt = `You are observing a person's life through their journal summaries.
Based on these recent memory summaries, identify the dominant theme of this period in their life.
Name this arc in 2-4 words. It should feel like a season or chapter title — poetic but grounded.
Write a 1-2 sentence description of what this arc represents.
Examples of arc titles: "The Quiet Builder", "Turning Inward", "Learning to Ship", "Restless Clarity"
...
{
  "title": "Arc Title Here",
  "description": "1-2 sentence description here"
}`;
  ...
  try {
    ...
    return {
      title: parsed.title ?? "A New Arc",
      description: parsed.description ?? ""
    };
  } catch (error: any) {
    console.error("Groq arc generation failed:", error.message);
